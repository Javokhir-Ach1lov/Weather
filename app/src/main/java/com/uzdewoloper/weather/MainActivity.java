package com.uzdewoloper.weather;
...
public class MainActivity extends AppCompatActivity {
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String[] args) {
            String response=HttpRequest.excuteGet ( "https://api.openweathermap.org/data/2.5/weatherq=" + CITY1 + "&units=metric&appid=c50f471ab8084fbe89d164240232602" );
